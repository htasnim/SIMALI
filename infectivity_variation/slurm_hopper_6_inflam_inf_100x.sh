...
#SBATCH --job-name=3D_multisac_run6inf10x
#SBATCh --output=3D_multisac_run6inf10x.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_inflam_inf_100x.config
