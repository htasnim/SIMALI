...
#SBATCH --time=2-00:00
#SBATCH --mem=500G   # Request memory per node
#SBATCH --job-name=dis_air_inf_run2
#SBATCh --output=dis_air_inf_run2.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=htasnim30@unm.edu

# Setup environment
export GASNET_MAX_SEGSIZE=2GB/P
...
module load upcxx/2022.3.0-kgqr

srun --mpi=pmi2 install/bin/simcov --config distributed_ran_air_infectable_2.config