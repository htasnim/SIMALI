...
#SBATCH --job-name=3D_multisac_run6_a5i20
#SBATCh --output=3D_multisac_run6_a5i20.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_a5i20.config