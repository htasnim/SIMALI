...
#SBATCH --job-name=3D_multisac_run6virprod1by100
#SBATCh --output=3D_multisac_run6virprod1by100.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_vir_prod_1by100.config
