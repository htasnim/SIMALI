...
#SBATCH --job-name=3D_multisac_run6virprod5x
#SBATCh --output=3D_multisac_run6virprod5x.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_vir_prod_5x.config
