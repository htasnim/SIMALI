...
#SBATCH --job-name=3D_multisac_run6int10x
#SBATCh --output=3D_multisac_run6int10x.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_inter_10x.config
