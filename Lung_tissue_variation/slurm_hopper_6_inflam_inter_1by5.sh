...
#SBATCH --job-name=3D_multisac_run6int1by5
#SBATCh --output=3D_multisac_run6int1by5.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_inter_1by5.config
