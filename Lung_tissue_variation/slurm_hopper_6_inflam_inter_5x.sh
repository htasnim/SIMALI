...
#SBATCH --job-name=3D_multisac_run6int5x
#SBATCh --output=3D_multisac_run6int5x.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_inter_5x.config
