...
#SBATCH --job-name=3D_multisac_run6inf1by10
#SBATCh --output=3D_multisac_run6inf1by10.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_inflam_inf_1by100.config
