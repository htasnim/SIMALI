...
#SBATCH --time=2-00:00
#SBATCH --job-name=3D_multisac_25pct_run2
#SBATCh --output=3D_multisac_25pct_run2.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run2_initial_vir_100.config