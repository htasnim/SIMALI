...
#SBATCH --job-name=3D_multisac_run6_inf20x
#SBATCh --output=3D_multisac_run6_inf20x.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_inf20x.config