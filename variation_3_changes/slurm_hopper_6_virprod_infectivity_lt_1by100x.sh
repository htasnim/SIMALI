...
#SBATCH --time=2-00:00
#SBATCH --job-name=3D_multisac_run6
#SBATCh --output=3D_multisac_run6.out
...
srun --mpi=pmi2 install/bin/simcov --config covid_multisac_run6_virprod_infectivity_lt_1by100x.config
